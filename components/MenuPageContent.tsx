...
export default function MenuPageContent({ categories }: Props) {
  const { t } = useLanguage();
  const pg = t.menuPage;

  return (
    <>
      <Breadcrumb items={[{ label: t.nav.menu, href: '/menu' }]} />
      ...
      <section className="py-20 bg-warm-gradient" aria-labelledby="menu-cta-heading">
        <div className="max-w-3xl mx-auto container-padding text-center">
          <div className="section-label justify-center mb-6">{pg.cta.label}</div>
          <h2
            id="menu-cta-heading"
