    ...
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto container-padding text-center">
          ...
          <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl font-bold text-stone-900 leading-tight">
            Let&apos;s <span className="italic text-rose-blush">Connect</span>
          </h1>
          <p className="mt-6 font-sans text-lg text-stone-600 max-w-xl mx-auto leading-relaxed">
            Have a custom order? A question about our menu? Just want to say hi?
              ...
              <div className="space-y-5">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="font-sans text-sm text-stone-500 mt-0.5">
                      Call or text anytime during hours
                    </div>
                  </div>
                </a>
                ...
                <div className="p-6 rounded-3xl bg-cream">
                  ...
                  <p className="mt-4 font-sans text-xs text-stone-400">
                    Freshest selection available first thing in the morning.
                    Arriving after noon? Call ahead to reserve.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-3">
              <div className="mb-8">
                ...
                <p className="font-sans text-stone-600 text-sm leading-relaxed">
                  For custom cake orders, catering requests, or general questions. We&apos;ll get back to
      ...
      <section className="py-16 bg-warm-gradient" aria-labelledby="contact-phone-cta">
        <div className="max-w-3xl mx-auto container-padding text-center">
          <p className="font-sans text-stone-500 text-sm mb-3">Need something faster?</p>
