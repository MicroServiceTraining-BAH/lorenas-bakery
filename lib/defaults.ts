...
export const DEFAULTS: Record<string, unknown> = {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'empanadas-loroco', name: 'Empanadas de Loroco', description: 'Savory Salvadoran empanadas filled with loroco flower and cheese. Order them if you see them.', price: '$3.50', tag: 'Signature', emoji: '', image: '' },
        ],
      },
      {
        id: 'cakes',
        ...
        items: [
          ...
          { id: 'quinceanera-cakes', name: 'Quinceañera Cakes', description: 'Custom tiered cakes for quinceañeras. Call to talk through the details.', price: 'Custom pricing', tag: 'Custom Order', emoji: '', image: '' },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'horchata', name: 'Horchata de Morro', description: 'Salvadoran horchata made with morro seeds, cinnamon, and sesame. Not the rice kind.', price: '$4.00', tag: 'Signature', emoji: '', image: '' },
          { id: 'atol-de-elote', name: 'Atol de Elote', description: 'Sweet corn drink made the traditional way. Warm, thick, and good.', price: '$3.50', tag: '', emoji: '', image: '' },
  ...
  home: {
    ...
    heading2: '& Pastries',
    heading3: 'Made Daily',
    body: 'Pan dulce, pastelitos, and café de olla — baked fresh every morning.',
    heroImage: '',
  } satisfies HomeData,
